...
const QuestionAndAnswer = () => {
  const qaBeginner = [
    ...
    },
    {
      ...
      answer:
        "更衣室を完備しておりますので、動きやすい格好をご準備ください。クラブ、シューズは無料レンタルがございますので手ぶらでお越しください。シューズレンタルの方は靴下をご準備ください。グローブのご用意もありますが、昨今の感染症対策で気になる方はご持参ください。",
    },
    {
      question: "ゴルフの道具、何も持ってないですが大丈夫ですか？",
      answer:
        "クラブ、シューズは無料レンタルがございますので手ぶらでお越しください。シューズレンタルの方は靴下をご準備ください。グローブはご準備はございますが昨今の感染症対策で気になる方はご持参ください。",
    },
  ]
  ...
  const qaFacility = [
    ...
    },
    {
      ...
      answer: "更衣室がございます。シャワーはございませんのでご了承ください。",
    },
    {
  ...
  const qaLesson = [
    {
      ...
      answer:
        "レッスン2名様まで（お客様2名に対して1名のインストラクター）の超少人数制のマンツーマンレッスンです。1名様あたりのレッスン時間は約25分となっており通常のグループレッスンよりインストラクターからのティーチング時間も多く且つパーソナルよりもお手軽価格となる、良いとこどりのレッスンスタイルです。",
    },
    {
      question:
  ...
  const qaSystem = [
    ...
    },
    {
      ...
      answer:
        "退会の際は、月末締めとなります。退会希望月の5日までにご来店いただきお手続きをお願いいたします。",
    },
    {
      question: "休会制度はありますか？",
      answer:
    ...
    },
    {
      ...
      answer:
        " ご入会ののち、パソコンやスマートフォンのブラウザからご希望のお時間にご予約いただく形となります。ご不明な点がございましたらお気軽にお問い合わせください。",
    },
    {
      question: "レッスン当日の受け付けなどのような手続きがありますか？",
      answer:
        "当店ではご予約と連動した入退室管理システムを利用しております。ご予約いただいたお時間の30分前にブラウザにカギが届きますのでそちらを使って入室ください。",
    },
    {
      question: "キャンセルしたい時はどうすれば良いのでしょうか？",
      answer:
        "キャンセルは2時間前までにご自身で、ブラウザで行っていただく形になっております。",
    },
  ]
